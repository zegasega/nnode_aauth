declare const _default: {
    ...
    readonly SENTINEL_SET: {
        readonly parseCommand: (this: void, parser: import("../../client/parser").CommandParser, dbname: import("../../RESP/types").RedisArgument, options: import("./SENTINEL_SET").SentinelSetOptions) => void;
        readonly transformReply: () => import("../../RESP/types").SimpleStringReply<"OK">;
    };
