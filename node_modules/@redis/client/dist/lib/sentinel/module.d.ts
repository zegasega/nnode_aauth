declare const _default: {
    readonly sentinel: {
        readonly SENTINEL_SENTINELS: {
            readonly parseCommand: (this: void, parser: import("../client/parser").CommandParser, dbname: import("../RESP/types").RedisArgument) => void;
        ...
        readonly SENTINEL_MONITOR: {
            readonly parseCommand: (this: void, parser: import("../client/parser").CommandParser, dbname: import("../RESP/types").RedisArgument, host: import("../RESP/types").RedisArgument, port: import("../RESP/types").RedisArgument, quorum: import("../RESP/types").RedisArgument) => void;
        ...
        readonly SENTINEL_SET: {
            readonly parseCommand: (this: void, parser: import("../client/parser").CommandParser, dbname: import("../RESP/types").RedisArgument, options: import("./commands/SENTINEL_SET").SentinelSetOptions) => void;
            readonly transformReply: () => import("../RESP/types").SimpleStringReply<"OK">;
        };
